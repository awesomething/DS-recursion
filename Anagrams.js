...
// the program should list all 24 permutations, including "eats", "etas", "teas", and non-words 
// like "tsae".
//
// Hint: For your algorithm, you might want to think about a prefix and use that to create the 
// new words. For example, given "east", use "e" as a prefix and place it in front of all 6 
// permutations of "ast" — "ast", "ats", "sat", "sta", "tas", and "tsa". This will give you the 
// words "east", "eats", "esat", "esta", "etas", and "etsa". Continue this way until you find all 
// the anagrams for "east". Then you can use "a" as a prefix and permute the remaining words "est". 
